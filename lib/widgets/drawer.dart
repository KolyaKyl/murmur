...
import 'package:self_screen/screens/tests_history_screen.dart';
...
class AppDrawer extends ConsumerStatefulWidget {
  ...
  const AppDrawer({super.key, required this.wellnessCardKey});
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              FirebaseService.logEvent('drawer_psytests_pressed');
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => TestsScreen(appUser: user),
                ),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.of(context).pop();
              FirebaseService.logEvent('drawer_moodanal_pressed');
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 30), // минимальный отступ
                Switch(
                  value: isDarkTheme,
                  onChanged: (val) async {
